...
public class indicatorForSoftball extends Activity {
    Context context=this;
    DataStore db = new DataStore(this);
    private Button SA, SD, BA, BD, OA, OD, GA, GD, Hit;
    private TextView visiting,home, textView1,visitingcount,homecount,
    ...
    private ImageView SLight1, SLight2, BLight1, BLight2, BLight3, OLight1,
            OLight2;
    private int Number_Count=1, Team, whichTeam=0, Scount = 1, Bcount = 1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Visiting = bundle.getString("visiting");
                ...
                if(isDou()) {
                    ...
                    builder.setPositiveButton(getString(R.string.yes),
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    if(Scount==1)
                                        Toast.makeText(context, getString(R.string.strikelow1), Toast.LENGTH_SHORT).show();
                                    else {
                                        Scount = Scount-1;
                                        setLight("SLight",Scount);
                                    }
                ...
                if(isDou()) {
                    ...
                    builder.setPositiveButton(getString(R.string.yes),
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    if(Bcount==1)
                                        Toast.makeText(context, getString(R.string.balllow1), Toast.LENGTH_SHORT).show();
                                    else {
                                        Bcount = Bcount-1;
                                        setLight("BLight",Bcount);
                                    }
