...
public class indicatorForSoftballTime extends Activity{
    ...
    private int Number_Count=1, Team, whichTeam=0, Time, pause=0, stop=0, Scount = 1, Bcount = 1,
    ...
    private void exitDoubleClick() {
        ...
        if (isExit == false) {
            isExit = true;
            Toast.makeText(this, getString(R.string.doubleclick), Toast.LENGTH_SHORT).show();
            timer = new Timer();
